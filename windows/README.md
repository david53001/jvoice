...
`dotnet test` = **1502/1502**, on-device transcription is verified (Vulkan GPU + CPU), and **the full
...
| `JVoice.Tests` | `net9.0` | xUnit suite locking the Core invariants (1502 tests). |
...
dotnet test  windows/JVoice.Tests/JVoice.Tests.csproj   # 1502/1502 expected
